...
double velDist( double y, double YS, double rhogx, double HN, double mu0, double Lx, double amp){
...
*/
  ...
  foreach() {
    u.x[] = velDist(y, tauy, (rho1*GRAVCOEFF*CHANNELSIN), normalDepth, mu1, hDist);
    u.y[] = 0.0;
