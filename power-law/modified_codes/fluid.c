 ...
 *
 * The gradient is normalized by the size of the cell and is limited
 * using a Yu limiter (beta = 1.3667).
 *
 * Returns: the value of the @c component of the gradient of variable @v
 * at the center of the cell.
 */
gdouble gfs_center_yu_gradient (FttCell * cell,
				   FttComponent c,
				   guint v)
{
  g_return_val_if_fail (cell != NULL, 0.);
...
/**
 * gfs_center_va_gradient:
 * @cell: a #FttCell.
 * @c: a component.
 * @v: a #GfsVariable index.
 *
 * The gradient is normalized by the size of the cell and is limited
 * using a van Albada limiter (beta = 1.5).
 *
 * Returns: the value of the @c component of the gradient of variable @v
 * at the center of the cell.
 */
gdouble gfs_center_va_gradient (FttCell * cell,
				   FttComponent c,
				   guint v)
{
  g_return_val_if_fail (cell != NULL, 0.);
...
/**
 * gfs_center_ospre_gradient:
 * @cell: a #FttCell.
 * @c: a component.
 * @v: a #GfsVariable index.
 *
 * The gradient is normalized by the size of the cell and is limited
 * using a OSPRE limiter (beta = 1.5).
 *
 * Returns: the value of the @c component of the gradient of variable @v
 * at the center of the cell.
 */
gdouble gfs_center_ospre_gradient (FttCell * cell,
				   FttComponent c,
				   guint v)
{
  g_return_val_if_fail (cell != NULL, 0.);
...
/**
 * gfs_center_vlSharp_gradient:
 * @cell: a #FttCell.
 * @c: a component.
 * @v: a #GfsVariable index.
 *
 * The gradient is normalized by the size of the cell and is limited
 * using a van-Leer with Klein's sharpening limiter (k = 2.0).
 *
 * Returns: the value of the @c component of the gradient of variable @v
 * at the center of the cell.
 */
gdouble gfs_center_vlSharp_gradient (FttCell * cell,
				   FttComponent c,
				   guint v)
{
  g_return_val_if_fail (cell != NULL, 0.);
...
/**
 * gfs_center_vlSharp04_gradient:
 * @cell: a #FttCell.
 * @c: a component.
 * @v: a #GfsVariable index.
 *
 * The gradient is normalized by the size of the cell and is limited
 * using a van-Leer with Klein's sharpening limiter (k = 0.4).
 *
 * Returns: the value of the @c component of the gradient of variable @v
 * at the center of the cell.
 */
gdouble gfs_center_vlSharp04_gradient (FttCell * cell,
				   FttComponent c,
				   guint v)
{
  g_return_val_if_fail (cell != NULL, 0.);
