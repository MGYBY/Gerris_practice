...
#define bParam 0.3826101
#define nHB 0.33333
#define froude 1.93495858837457
...
#define colorbarMax (normalMaxVel*5.00)
...
#define visRegThre 1.2e-10
#define yieldSurfThre 1.1e-10
 ...
 */
event adapt1 (i++) {
  adapt_wavelet({h, depthGrad, uAve, yieldSurf}, (double[]){normalDepth/325.0, 0.005, normalVel/325.0, normalDepth/200.0}, maxlevel = MAXLEVEL, minlevel = MINLEVEL);
